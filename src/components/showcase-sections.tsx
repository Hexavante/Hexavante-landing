import { BarChart3, Crown, HelpCircle, Hexagon, Radio, ShoppingBag, Trophy, Users, ArrowRight, Lock } from "lucide-react";
...
export function CompeteSection() {
  return (
    <section id="competir" className="scroll-mt-24 border-t border-white/[0.06] bg-white/[0.02] py-24 sm:py-32">
        ...
        <ScrollReveal>
          <div className="mx-auto mb-12 max-w-2xl text-center">
            ...
            <p className="mt-5 text-base text-[hsl(var(--sidebar-foreground)/0.56)]">
              Ranking, loja, salas ao vivo e conquistas — uma prévia visual do que te espera no app.
            </p>
          </div>
        </ScrollReveal>
...
export function PlatformSection() {
  return (
    <section id="plataforma" className="scroll-mt-24 border-t border-white/[0.06] py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <ScrollReveal>
          <div className="mx-auto mb-12 max-w-2xl text-center">
            <div className="mb-5 inline-flex items-center gap-2 hx-intro-chip">
            ...
            <p className="mt-5 text-base text-[hsl(var(--sidebar-foreground)/0.56)]">
              Estatísticas, evolução, ajuda e muito mais — prévia visual dos recursos do app.
            </p>
          </div>
        </ScrollReveal>
